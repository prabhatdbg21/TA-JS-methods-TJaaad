...
if (message.slice(3 , 6) == "you"){
    console.log (`word is ${message.slice(3 , 6)}`) ;
}
*/

message.slice(3 , 6) == "you" ? console.log (`word is you`) : console.log (`word is not you`) ;

// Check and log whether the word from index 7 to 8 is "a" or not
message.slice(7, 8) == "a" ? console.log (`word is a`) : console.log (`word is not a`) ;

// Check and log whether the last 3 character in message is "no!" or not (you can use -3 in slice)
message.slice(-3) == "no!" ? console.log (`word is no!`) : console.log (`word is not no!`) ;

// Check and log whether the last 5 character in message is "no!" or not
message.slice(-5) == "no!" ? console.log (`word is no!`) : console.log (`word is not no!`) ;
...
for (let character of message){
    console.log ( message.charAt(character))
}
*/
